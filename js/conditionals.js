...
function calculateTotal(luckyNumber, totalCost) {
    switch (luckyNumber) {
        case 0:
            ...
            case 2:
            return totalCost - (totalCost * .25);

            case 3:
            return totalCost - (totalCost * .35);
...
alert("Your total amount was, $" + totalBill)
...
if (confirm("Would you like to enter a number?")) {
    const usersNumber = parseFloat(prompt("What is your number?"));
    ...
    if (!isNaN(usersNumber)) {
        ...
        let plus100 = usersNumber + 100;
        alert("This is your number + 100: " + plus100);
